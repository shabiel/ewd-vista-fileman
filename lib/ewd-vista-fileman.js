  ...
  handlers: {
    ...
    filemanDicSync: function(query) {
      ...
      requires this to be the worker process for the calling module handler:
        let result = this.handlers['ewd-vista-fileman'].filemanDicSync.call(this, filemanMsg);
      */
    ...
    filemanDic: function(messageObj, session, send, finished) {
      ...
      query.screen = '';
      let results  = listDicSync.call(this, query);
    ...
    laygo: function(messageObj, session, send, finished) {
